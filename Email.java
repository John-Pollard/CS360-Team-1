...
public class Email {
	...
	public static void emailRx(String fname, String patientEmail, String prescription, String instructions, String notes) {
		
		final String email = "doctorCS360@gmail.com";
    ...
    /*public static void main(String[] args) {
    	emailRx("Audra", "beaca01@pfw.edu", "Cheesy potatoes", "Take cheesy potatoes once every month. Best eaten with sloppy joe.", "Cheesy potatoes are very yummy so you should not deprive yourself of them.");
